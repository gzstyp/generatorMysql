	...
	<body onload="parent.layer.closeAll();">
		<div id="page-index">
	  		...
	  		<div class="index-uname">
	  			...
	  			<input type="text" class="login-input userName_pwd" value="admin" autocomplete="off" style="width: 200px;" id="uname" maxlength="64" placeholder="请输入登录账号"/>
	  		</div>
	  		<div class="index-upwd">
	  			<span class="span_display">密码</span>
	  			<input type="password" class="login-input userName_pwd" value="qq" onpaste="return false" oncontextmenu="return false" oncopy="return false" oncut="return false" style="width: 200px;" id="upwd" maxlength="64" placeholder="请输入账号密码"/>
	  		</div>
	  		<div class="index-code">
	  			<span class="span_display">验证码</span>
                <input type="text" class="login-input" style="width: 116px;position: relative;left:60px;top:-24px;" id="code" value="1" maxlength="10" placeholder="输入图形验证码"/>
