...
;(function(){
    ...
    window.layerFn = {
        ...
        center : function(code,msg){
            ...
            var exitIndex = al_t.layer.alert('<div style="font-size: 12px;"><img src='+imagerUrl+' style="vertical-align:middle;margin-right:3px;"/>'+msg+'</div>',{title : AppKey.title,area : AppKey.layerArea});
            layerFn.EscLayer(exitIndex);
        },
